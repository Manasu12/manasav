    ...
    while(1)
{
    ...
    printf("\n\n\t\t\t10. List of Employee From Mysuru");
...
void frmmysuru(FILE * fp)
{
    printHead();
     printf("\n\t\t\t\List of Employee From Mysuru");//sohanuzzaman_soad
    Employee e;
    int i,siz=sizeof(e);
    ...
    while((fread(&e,siz,1,fp))==1)
    {
        if((strstr(e.prtaddr,"Mysuru")==0)||(strstr(e.prtaddr,"mysuru")==0)||(strstr(e.prtaddr,"MYSURU")==0))
        {
        printf("\n\n\t\tID : %d",e.id);
        printf("\n\n\t\tNAME : %s",e.name);
        printf("\n\n\t\tDESIGNATION : %s",e.desgn);
...
void frmors(FILE * fp)
{
    ...
    while((fread(&e,siz,1,fp))==1)
    {
        if((strstr(e.prtaddr,"Mysuru")==1)&&(strstr(e.prtaddr,"mysuru")==1)&&(strstr(e.prtaddr,"MYSURU")==1))
        {
        printf("\n\n\t\tID : %d",e.id);
        printf("\n\n\t\tNAME : %s",e.name);
        printf("\n\n\t\tDESIGNATION : %s",e.desgn);
